...
//Register DI
builder.Services.AddScoped<IPosition, PositionData>();
...
builder.Services.AddScoped<IAttendance, AttendanceData>();

builder.Services.AddScoped<IPayrollDetails, PayrollDetailsData>();
...
{
	c.SwaggerDoc("v1", new OpenApiInfo { Title = "PayrollBSI.API", Version = "v1" });
